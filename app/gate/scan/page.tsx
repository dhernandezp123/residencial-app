  ...
  return (
    <main className="min-h-screen bg-green-950 px-5 py-6 text-white">
      <div className="mx-auto max-w-sm space-y-5">
        ...
        <button
          type="button"
          onClick={() => toast.info('Registro de ingreso pendiente')}
          className="min-h-14 w-full rounded-2xl bg-white px-4 py-4 text-lg font-black text-green-800 shadow-xl active:scale-[0.99]"
        >
          Registrar ingreso
        </button>
      </div>
