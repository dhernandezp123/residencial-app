...
export function PrimaryActionCard({
  ...
  title,
  subtitle,
  className = 'group flex min-h-40 flex-col justify-between overflow-hidden rounded-3xl bg-[#15936A] p-4 text-white shadow-xl shadow-emerald-950/25 transition-all duration-200 ease-out hover:-translate-y-[1px] hover:shadow-lg active:scale-[0.98]',
